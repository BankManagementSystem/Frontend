...
<div class="bg-gray-300 min-h-screen p-8">
	<div class="max-w-lg mx-auto bg-white p-8 rounded-md shadow-md">
		<!-- Type of Loan -->
		<div class="mb-4">
			<label class="block text-gray-700 font-medium" for="LoanType">Type of Loan</label>
			<input
				id="LoanType"
				type="text"
		...
		<div class="mb-4">
			...
			<input
				...
				bind:value={loanAmount}
			/>
			<p class="text-sm text-gray-500 text-right">Max ₹50,00,000</p>
		</div>
